...
readIEA_Energy_End_uses_and_Efficiency_Indicators <- function(subtype = "GENERIC") {
  ...
  list(x = x,
       ...
       description = c(category = "Energy end-uses and efficiency indicators",
                       type = "The Energy End-uses and Efficiency Indicators database  covering end use energy consumption by energy product, end use carbon emissions, associated indicators across four sectors of final consumption and energy decomposition analysis",
