#' readff55NonCo2GHGEmissions
#'
#' Read ff55NonCo2GHGEmissions of EU
#'
...
#' @examples
#' \dontrun{
#' a <- readSource("ff55NonCo2GHGEmissions", convert = FALSE)
#' }
#'
...
#'
readff55NonCo2GHGEmissions <- function() {
  
  sheetNames <- excel_sheets("ff55_reg_non-co2_ghg_emissions.xlsx")
  
  # Read sheets into a named list
  sheets <- lapply(sheetNames, read_excel, path = "ff55_reg_non-co2_ghg_emissions.xlsx")
  ...
  list(
    ...
    weight = NULL,
    description = c(
      category = "Non_Co2_GHG_Emissions",
      type = "Emissions",
