...
calcIFuelPrice <- function() {
  ...
  # BGDO
  MultByShare[,,"PC.USD2015/toe.BGDO"] <- MultByShare[,,"PC.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"PC.shareBGDO"])
  MultByShare[,,"PC.USD2015/toe.GDO"] <- MultByShare[,,"PC.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"PC.shareBGDO"]))
  
  MultByShare[,,"PB.USD2015/toe.BGDO"] <- MultByShare[,,"PB.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"PB.shareBGDO"])
  MultByShare[,,"PB.USD2015/toe.GDO"] <- MultByShare[,,"PB.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"PB.shareBGDO"]))
  
  MultByShare[,,"PT.USD2015/toe.BGDO"] <- MultByShare[,,"PT.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"PT.shareBGDO"])
  MultByShare[,,"PT.USD2015/toe.GDO"] <- MultByShare[,,"PT.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"PT.shareBGDO"]))
  
  MultByShare[,,"PN.USD2015/toe.BGDO"] <- MultByShare[,,"PN.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"PN.shareBGDO"])
  MultByShare[,,"PN.USD2015/toe.GDO"] <- MultByShare[,,"PN.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"PN.shareBGDO"]))
  
  MultByShare[,,"GT.USD2015/toe.BGDO"] <- MultByShare[,,"GT.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"GT.shareBGDO"])
  MultByShare[,,"GT.USD2015/toe.GDO"] <- MultByShare[,,"GT.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"GT.shareBGDO"]))
  
  MultByShare[,,"GN.USD2015/toe.BGDO"] <- MultByShare[,,"GN.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"GN.shareBGDO"])
  MultByShare[,,"GN.USD2015/toe.GDO"] <- MultByShare[,,"GN.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"GN.shareBGDO"]))
  
  MultByShare[,,"GU.USD2015/toe.BGDO"] <- MultByShare[,,"GU.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"GU.shareBGDO"])
  MultByShare[,,"GU.USD2015/toe.GDO"] <- MultByShare[,,"GU.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"GU.shareBGDO"]))
  
  # BGSL
  MultByShare[,,"PC.USD2015/toe.BGSL"] <- MultByShare[,,"PC.USD2015/toe.GSL"] * sqrt(SharesFuelPrices[,,"PC.shareBGSL"])
  MultByShare[,,"PC.USD2015/toe.GSL"] <- MultByShare[,,"PC.USD2015/toe.GSL"] * (1/sqrt(SharesFuelPrices[,,"PC.shareBGSL"]))
  
  MultByShare[,,"PB.USD2015/toe.BGSL"] <- MultByShare[,,"PB.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"PB.shareBGSL"])
  MultByShare[,,"PB.USD2015/toe.GSL"] <- MultByShare[,,"PB.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"PB.shareBGSL"]))
  
  MultByShare[,,"GU.USD2015/toe.BGSL"] <- MultByShare[,,"GU.USD2015/toe.GDO"] * sqrt(SharesFuelPrices[,,"GU.shareBGSL"])
  MultByShare[,,"GU.USD2015/toe.GSL"] <- MultByShare[,,"GU.USD2015/toe.GDO"] * (1/sqrt(SharesFuelPrices[,,"GU.shareBGSL"]))
  
  # BKRS
  MultByShare[,,"PA.USD2015/toe.BKRS"] <- MultByShare[,,"PA.USD2015/toe.KRS"] * sqrt(SharesFuelPrices[,,"PA.shareBKRS"])
