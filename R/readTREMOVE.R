...
readTREMOVE <- function(subtype = "Activity") {
  ...
  if (subtype == "FuelOutlook") {
    ...
    for (i in list.files(".")) {
      ...
      x1 <- x1[c(6,9,12,15:17,19,23,24,30,117,121,122:124,126:128,132,136,140,144:153,
                 351,355,356:358,360:362,366,370,374,378:387,507,511,512:514,516:518,
                 ...
                 1288,1292,1293:1295,1297:1299,1303,1307,1311,1315:1324,1366,1370,
                 1371:1373,1375:1377,1381,1385,1389,1393:1402),-c(2,17:23)]
      ...
      x1[435 : 728, 4] <- "Private cars"
      
      x1[729 : 1022, 4] <- "Passenger Light Duty Vehicles"
      
      x1[1023 : 1316, 4] <- "Trucks"
      
      x1[1317 : 1610, 4] <- "Rail"
      
      x1[1611 : 1904, 4] <- "Passenger trains"
      
      x1[1905 : 2198, 4] <- "Freight trains"
      
      x1[2199 : 2492, 4] <- "Aviation"
      
      x1[2493 : 2786, 4] <- "Inland navigation"
      
      x1[2787 : 3080, 4] <- "Freight inland navigation"
