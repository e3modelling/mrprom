  ...
  if (subtype == "FuelOutlook") {
    ...
    for (i in list.files(".")) {
      ...
      x1 <- x1[c(6,9,12,15:17,19,23,24,30,117,121,122,126:128,132,136,140,144:153,
                 351,355,356,360:362,366,370,374,378:387,507,511,512,516:518,
                 522,526,530,534:543,547,551,552,556:558,562,566,570,574:583,
                 821,825,826,830:832,836,840,844,848:857,860,864,865,869:871,
                 875,879,883,887:896,1016,1020,1021,1025:1027,1031,1035,1039,
                 1043:1052,1055,1059,1060,1064:1066,1070,1074,1078,1082:1091,
                 1288,1292,1293,1297:1299,1303,1307,1311,1315:1324,1366,1370,
                 1371,1375:1377,1381,1385,1389,1393:1402),-c(2,17:23)]
      ...
      x1[673 : 938, 4] <- "Passenger Light Duty Vehicles"
      
      x1[939 : 1204, 4] <- "Trucks"
      
      x1[1205 : 1470, 4] <- "Rail"
      
      x1[1471 : 1736, 4] <- "Passenger trains"
      
      x1[1737 : 2002, 4] <- "Freight trains"
      
      x1[2003 : 2268, 4] <- "Aviation"
      
      x1[2268 : 2534, 4] <- "Inland navigation"
      
      x1[2535 : 2800, 4] <- "Freight inland navigation"
