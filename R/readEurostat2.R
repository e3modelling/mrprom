...
readEurostat2 <- function(subtype = "SIOT", subset = "all") {
  ...
  if (subtype == "SIOT") {
    SIOT_prd <- get_eurostat("naio_10_cp1700", time_format = "raw",
    ...
    if (subset  == "all") {
      ...
      x <- filter(SIOT_prd, SIOT_prd[["stk_flow"]] == subset)
    }
    ...
    SUPL <- get_eurostat("naio_10_cp15", time_format = "raw",
                         stringsAsFactors = TRUE)
    ...
    USE_p <- get_eurostat("naio_10_cp16", time_format = "raw",
                          stringsAsFactors = TRUE)
    ...
    TRM <- get_eurostat("naio_10_cp1620", time_format = "raw",
                        stringsAsFactors = TRUE)
    ...
    TAXSUB <- get_eurostat("naio_10_cp1630", time_format = "raw",
                           stringsAsFactors = TRUE)
    ...
    BTRADE_SRV <- get_eurostat("bop_its6_det", time_format = "raw",
                               stringsAsFactors = TRUE)
    ...
    POP_NAT <- get_eurostat("nama_10_pe", time_format = "raw",
                            stringsAsFactors = TRUE)
    ...
    EMP_SEC <- get_eurostat("nama_10_a64_e", time_format = "raw",
                            stringsAsFactors = TRUE)
    ...
    DEMO <- get_eurostat("demo_pjan", time_format = "raw",
                         stringsAsFactors = TRUE)
    ...
    LFS_POP <- get_eurostat("lfsa_pganws", time_format = "raw",
                            stringsAsFactors = TRUE)
    ...
    LFS_EMP <- get_eurostat("lfsa_eisn2", time_format = "raw",
                            stringsAsFactors = TRUE)
    ...
    LFS_UNEMP <- get_eurostat("lfsa_ugpis", time_format = "raw",
                              stringsAsFactors = TRUE)
    ...
    NFTR <- get_eurostat("nasa_10_nf_tr", time_format = "raw",
                         stringsAsFactors = TRUE)
    ...
    FTR <- get_eurostat("nasa_10_f_tr", time_format = "raw",
                        stringsAsFactors = TRUE)
    ...
    ENV <- get_eurostat("env_ac_ainah_r2", time_format = "raw",
                        stringsAsFactors = TRUE)
    ...
    COICOP <- get_eurostat("nama_10_co3_p3", time_format = "raw",
                           stringsAsFactors = TRUE)
