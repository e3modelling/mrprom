...
calcEurostat2 <- function(subtype = "SIOT", subset = "all", select = "one" ) {
  ...
  if (subtype == "SIOT") {
    ...
    qx <- as.quitte(x)
    gdx <- NULL
    gdx$val <-matrix(c(1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),qx$value),nrow=nrow(qx))
    gdx$dim <- 6
    gdx$name <- "SIOT"
    gdx$type <- "parameter"
    gdx$form <- "sparse"
    gdx$ts <- "Symmetric input-output table at basic prices (product by product)"
    gdx$domains = c(names(dimnames(x))[1],names(dimnames(x))[2],strsplit(names(dimnames(x))[[3]],"\\.")[[1]])
    ...
    qx <- as.quitte(x)
    gdx <- NULL
    gdx$val <-matrix(c(1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),qx$value),nrow=nrow(qx))
    gdx$dim <- 5
    gdx$name <- "EMP_SEC"
    gdx$type <- "parameter"
    gdx$form <- "sparse"
    ...
    qx <- as.quitte(x)
    gdx <- NULL
    gdx$val <- matrix(c(1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),qx$value),nrow=nrow(qx))
    gdx$dim <- 4
    gdx$type <- "parameter"
    gdx$name <- "POP_NAT"
    gdx$form <- "sparse"
    ...
    qx <- as.quitte(x)
    gdx <- NULL
    gdx$val <-matrix(c(1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),1:nrow(qx),qx$value),nrow=nrow(qx))
    gdx$dim <- 7
    gdx$name <- "LFS_POP"
    gdx$type <- "parameter"
    gdx$form <- "sparse"
  ...
  if (select == "one"){writeGDX(gdx,paste0(subtype,subset,".gdx"))
  } else if (select == "all") {
    ...
    qx2 <- as.quitte(x2)
    gdx2 <- NULL
    gdx2$val <-matrix(c(1:nrow(qx2),1:nrow(qx2),1:nrow(qx2),1:nrow(qx2),1:nrow(qx2),qx2$value),nrow=nrow(qx2))
    gdx2$dim <- 5
    gdx2$name <- "LFS_UNEMP"
    gdx2$type <- "parameter"
    gdx2$form <- "sparse"
    gdx2$ts <- "Previous occupations of the unemployed, by sex"
    gdx2$domains = c(names(dimnames(x2))[1],names(dimnames(x2))[2],strsplit(names(dimnames(x2))[[3]],"\\.")[[1]])
    ...
    qx3 <- as.quitte(x3)
    gdx3 <- NULL
    gdx3$val <-matrix(c(1:nrow(qx3),1:nrow(qx3),1:nrow(qx3),1:nrow(qx3),1:nrow(qx3),1:nrow(qx3),1:nrow(qx3),qx3$value),nrow=nrow(qx3))
    gdx3$dim <- 7
    gdx3$name <- "LFS_EMP"
    gdx3$type <- "parameter"
    gdx3$form <- "sparse"
    gdx3$ts <- "Employment by sex, age, occupation and economic activity"
    gdx3$domains = c(names(dimnames(x3))[1],names(dimnames(x3))[2],strsplit(names(dimnames(x3))[[3]],"\\.")[[1]])
    ...
    qx4 <- as.quitte(x4)
    gdx4 <- NULL
    gdx4$val <-matrix(c(1:nrow(qx4),1:nrow(qx4),1:nrow(qx4),1:nrow(qx4),1:nrow(qx4),1:nrow(qx4),qx4$value),nrow=nrow(qx4))
    gdx4$dim <- 6
    gdx4$name <- "SIOT"
    gdx4$type <- "parameter"
    gdx4$form <- "sparse"
    gdx4$ts <- "Symmetric input-output table at basic prices (product by product)"
    gdx4$domains = c(names(dimnames(x4))[1],names(dimnames(x4))[2],strsplit(names(dimnames(x4))[[3]],"\\.")[[1]])
    ...
    qx5 <- as.quitte(x5)
    gdx5 <- NULL
    gdx5$val <-matrix(c(1:nrow(qx5),1:nrow(qx5),1:nrow(qx5),1:nrow(qx5),1:nrow(qx5),qx5$value),nrow=nrow(qx5))
    gdx5$dim <- 5
    gdx5$name <- "EMP_SEC"
    gdx5$type <- "parameter"
    gdx5$form <- "sparse"
    gdx5$ts <- "National accounts aggregates by industry"
    gdx5$domains = c(names(dimnames(x5))[1],names(dimnames(x5))[2],strsplit(names(dimnames(x5))[[3]],"\\.")[[1]])
    ...
    qx6 <- as.quitte(x6)
    gdx6 <- NULL
    gdx6$val <-matrix(c(1:nrow(qx6),1:nrow(qx6),1:nrow(qx6),1:nrow(qx6),1:nrow(qx6),1:nrow(qx6),qx6$value),nrow=nrow(qx6))
    gdx6$dim <- 6
    gdx6$name <- "SUPL"
    gdx6$type <- "parameter"
    gdx6$form <- "sparse"
    gdx6$ts <- "Supply table at basic prices incl. transformation into purchasers' prices"
    gdx6$domains = c(names(dimnames(x6))[1],names(dimnames(x6))[2],strsplit(names(dimnames(x6))[[3]],"\\.")[[1]])
    ...
    qx7 <- as.quitte(x7)
    gdx7 <- NULL
    gdx7$val <-matrix(c(1:nrow(qx7),1:nrow(qx7),1:nrow(qx7),1:nrow(qx7),1:nrow(qx7),1:nrow(qx7),qx7$value),nrow=nrow(qx7))
    gdx7$dim <- 6
    gdx7$name <- "USEp"
    gdx7$type <- "parameter"
    gdx7$form <- "sparse"
    gdx7$ts <- "Use table at purchasers' prices"
    gdx7$domains = c(names(dimnames(x7))[1],names(dimnames(x7))[2],strsplit(names(dimnames(x7))[[3]],"\\.")[[1]])
    ...
    qx8 <- as.quitte(x8)
    gdx8 <- NULL
    gdx8$val <-matrix(c(1:nrow(qx8),1:nrow(qx8),1:nrow(qx8),1:nrow(qx8),1:nrow(qx8),1:nrow(qx8),qx8$value),nrow=nrow(qx8))
    gdx8$dim <- 6
    gdx8$name <- "TRM"
    gdx8$type <- "parameter"
    gdx8$form <- "sparse"
    gdx8$ts <- "Table of trade and transport margins"
    gdx8$domains = c(names(dimnames(x8))[1],names(dimnames(x8))[2],strsplit(names(dimnames(x8))[[3]],"\\.")[[1]])
    ...
    qx9 <- as.quitte(x9)
    gdx9 <- NULL
    gdx9$val <-matrix(c(1:nrow(qx9),1:nrow(qx9),1:nrow(qx9),1:nrow(qx9),1:nrow(qx9),1:nrow(qx9),qx9$value),nrow=nrow(qx9))
    gdx9$dim <- 6
    gdx9$name <- "TAX"
    gdx9$type <- "parameter"
    gdx9$form <- "sparse"
    gdx9$ts <- "Table of taxes less subsidies on product"
    gdx9$domains = c(names(dimnames(x9))[1],names(dimnames(x9))[2],strsplit(names(dimnames(x9))[[3]],"\\.")[[1]])
    ...
    qx10 <- as.quitte(x10)
    gdx10 <- NULL
    gdx10$val <-matrix(c(1:nrow(qx10),1:nrow(qx10),1:nrow(qx10),1:nrow(qx10),1:nrow(qx10),1:nrow(qx10),qx10$value),nrow=nrow(qx10))
    gdx10$dim <- 6
    gdx10$name <- "BTRADE"
    gdx10$type <- "parameter"
    gdx10$form <- "sparse"
    gdx10$ts <- "International trade in services"
    gdx10$domains = c(names(dimnames(x10))[1],names(dimnames(x10))[2],strsplit(names(dimnames(x10))[[3]],"\\.")[[1]])
    ...
    qx11 <- as.quitte(x11)
    gdx11 <- NULL
    gdx11$val <- matrix(c(1:nrow(qx11),1:nrow(qx11),1:nrow(qx11),1:nrow(qx11),1:nrow(qx11),qx11$value),nrow=nrow(qx11))
    gdx11$dim <- 5
    gdx11$type <- "parameter"
    gdx11$name <- "DEMO"
    gdx11$form <- "sparse"
    gdx11$domains = c(names(dimnames(x11))[1],names(dimnames(x11))[2],strsplit(names(dimnames(x11))[[3]],"\\.")[[1]])
    ...
    qx12 <- as.quitte(x12)
    gdx12 <- NULL
    gdx12$val <-matrix(c(1:nrow(qx12),1:nrow(qx12),1:nrow(qx12),1:nrow(qx12),1:nrow(qx12),1:nrow(qx12),1:nrow(qx12),qx12$value),nrow=nrow(qx12))
    gdx12$dim <- 7
    gdx12$name <- "LFS_POP"
    gdx12$type <- "parameter"
    gdx12$form <- "sparse"
    gdx12$ts <- "Population by sex, age, citizenship and labour status"
    gdx12$domains = c(names(dimnames(x12))[1],names(dimnames(x12))[2],strsplit(names(dimnames(x12))[[3]],"\\.")[[1]])
    ...
    qx13 <- as.quitte(x13)
    gdx13 <- NULL
    gdx13$val <-matrix(c(1:nrow(qx13),1:nrow(qx13),1:nrow(qx13),1:nrow(qx13),1:nrow(qx13),1:nrow(qx13),qx13$value),nrow=nrow(qx13))
    gdx13$dim <- 6
    gdx13$name <- "NFTR"
    gdx13$type <- "parameter"
    gdx13$form <- "sparse"
    gdx13$ts <- "Non-financial transactions - annual data"
    gdx13$domains = c(names(dimnames(x13))[1],names(dimnames(x13))[2],strsplit(names(dimnames(x13))[[3]],"\\.")[[1]])
    ...
    qx14 <- as.quitte(x14)
    gdx14 <- NULL
    gdx14$val <-matrix(c(1:nrow(qx14),1:nrow(qx14),1:nrow(qx14),1:nrow(qx14),1:nrow(qx14),1:nrow(qx14),1:nrow(qx14),qx14$value),nrow=nrow(qx14))
    gdx14$dim <- 7
    gdx14$name <- "FTR"
    gdx14$type <- "parameter"
    gdx14$form <- "sparse"
    gdx14$ts <- "Financial transactions - annual data"
    gdx14$domains = c(names(dimnames(x14))[1],names(dimnames(x14))[2],strsplit(names(dimnames(x14))[[3]],"\\.")[[1]])
    ...
    qx15 <- as.quitte(x15)
    gdx15 <- NULL
    gdx15$val <-matrix(c(1:nrow(qx15),1:nrow(qx15),1:nrow(qx15),1:nrow(qx15),1:nrow(qx15),qx15$value),nrow=nrow(qx15))
    gdx15$dim <- 5
    gdx15$name <- "ENV"
    gdx15$type <- "parameter"
    gdx15$form <- "sparse"
    gdx15$ts <- "Air emissions accounts by NACE Rev. 2 activity"
    gdx15$domains = c(names(dimnames(x15))[1],names(dimnames(x15))[2],strsplit(names(dimnames(x15))[[3]],"\\.")[[1]])
    ...
    qx16 <- as.quitte(x16)
    gdx16 <- NULL
    gdx16$val <-matrix(c(1:nrow(qx16),1:nrow(qx16),1:nrow(qx16),1:nrow(qx16),qx16$value),nrow=nrow(qx16))
    gdx16$dim <- 4
    gdx16$name <- "COICOP"
    gdx16$type <- "parameter"
    gdx16$form <- "sparse"
    gdx16$ts <- "Final consumption expenditure of households by consumption purpose"
    gdx16$domains = c(names(dimnames(x16))[1],names(dimnames(x16))[2],strsplit(names(dimnames(x16))[[3]],"\\.")[[1]])
    ...
    wgdx("ALL.gdx",gdx,gdx2,gdx3,gdx4,gdx5,gdx6,gdx7,gdx8,gdx9,gdx10,gdx11,gdx12,gdx13,gdx14,gdx15,gdx16)
  }
