---
title: "mrprom"
description: "Creating input datasets for OPEN-PROM.\n"
output:
...
Framework idea
The problem with Excel tables:
Intransparent 
Not reproducible
Virtually impossible to track changes
Error-prone 
Not suitable for large datasets
Use of proprietary software

The Solution:
MADRaT (May All Data be Reproducible and Transparent)
Dietrich et al. (2025). "madrat: May All Data be Reproducible and Transparent (MADRaT)" 
"Tools used"
...
Typical workflow
mrprom: 
A) requires a local directory to store data such as downloaded  source data, cache files, and 
 output
B) has the ability to load data from cache rather than recompute it when the calculations have run
 already before
C) splits the data preparation into separate steps
"Tools used"
