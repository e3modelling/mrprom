...
format: html
description: |
  This vignette demonstrates the FuelPrice data and visualization.
vignette: >
...
"IEA has data for 145 countries and 6 regions until year 2023"
"The readIEATOTPRICES is used to read IEA data."
"The data is filtered by product = PRICE_TOTAL and by  CURENCY = USD_R"
### Example: Read and Preview IEA TOTPRICES Data
...
```
"The units are converted to "USD2015/toe" in convertIEATOTPRICES"
"Region mean is used for the rest countries that do not have data"
